 ...
 *       anchor-less forked_from → "sunny-forest#root-30"
 ...
 *       user_message m-user-1 (forked_from) → "sunny-forest#root-50",
...
const NODES: Record<string, FixtureNode[]> = {
  "sunny-forest": [
    ...
    // message with the base tree → anchor-less forked_from.
    {
      nodeId: 30,
      parentNodeId: 99,
    ...
    // Root sharing [system, user] prefix → forked_from anchored at
